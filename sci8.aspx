<%@ Page Title="" Language="C#" MasterPageFile="~/BookShelf.Master" AutoEventWireup="true" CodeFile="sci8.aspx.cs" Inherits="sci8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <div class="section">
        <div class="card">
            <div class="card_img">
                <asp:Image ID="Image5" runat="server" Width="350px" Height="500px" ImageUrl="~/Images/Scs8.jpeg" />
            </div>
        </div>
        <div class="card1">
            <div class="card_cont">
                ...
                <asp:Label ID="Label1" runat="server" class="lab" Text="Hyperion"></asp:Label>
                <br />
                <h2>
                    Price
                </h2>
                <asp:Label ID="Label2" runat="server" Text="Rs "></asp:Label>
                <asp:Label ID="Label3" runat="server" class="lab" Text="894"></asp:Label>
                ...
                <div class="tbl" align="center">
                    <table border="1" width="350px" height="100px">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label7" runat="server" Text="Del Rey; Reprint edition (15 August 2017)"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label9" runat="server" Text="978-0399178610"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="Dan Simmons"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </div>
