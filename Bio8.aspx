<%@ Page Title="" Language="C#" MasterPageFile="~/BookShelf.Master" AutoEventWireup="true" CodeFile="Bio8.aspx.cs" Inherits="Bio8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="section">
        <div class="card">
            <div class="card_img">
                <asp:Image ID="Image5" runat="server" Width="350px" Height="500px" ImageUrl="~/Images/Bio8.jpg" />
            </div>
        </div>
        <div class="card1">
            <div class="card_cont">
                ...
                <asp:Label ID="Label1" runat="server" class="lab" Text="Mahatma Gandhi: A Biography"></asp:Label>
                <br />
                <h2>
                    Price
                </h2>
                <asp:Label ID="Label2" runat="server" Text="Rs "></asp:Label>
                <asp:Label ID="Label3" runat="server" class="lab" Text="341"></asp:Label>
                ...
                <div class="tbl" align="center">
                    <table border="1" width="350px" height="100px">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label9" runat="server" Text="9780195623451"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="Label5" runat="server" Text="B.R.Nanda"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </div>
